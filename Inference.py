...
parser.add_argument('--modelpath', type=str, default="weights/129EDSR.pth", help=("path to the model .pth files"))
...
parser.add_argument('--bottleneck', type=int, default=32, help="set number of filters")
parser.add_argument('--n_resblock', type=int, default=5, help="set number of filters")
